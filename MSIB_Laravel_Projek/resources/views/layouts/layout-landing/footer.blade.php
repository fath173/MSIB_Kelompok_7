            ...
            <div class="row">
                ...
                <div class="col-lg-4 footer_col">
                    <div class="footer_about">
                        ...
                        <ul class="footer_about_list">
                            <li>
                                <div class="footer_about_icon"><img src="{{ asset('assets/landing/images/phone-call.svg') }}" alt=""></div>
                                <span>+45 677 8993000 223</span>
                            </li>
                            <li>
                                <div class="footer_about_icon"><img src="{{ asset('assets/landing/images/envelope.svg') }}" alt=""></div>
                                <span>vaksin_official@gmail.com</span>
                            </li>
                            <li>
                                <div class="footer_about_icon"><img src="{{ asset('assets/landing/images/placeholder.svg') }}" alt=""></div>
                ...
                <div class="col-lg-4 footer_col">
                    <div class="footer_news footer_column">
                        ...
                        <ul>
                            <li>
                                <div class="footer_news_title"><a href="news.html">Aliquam ac eleifend
                                        metus</a></div>
