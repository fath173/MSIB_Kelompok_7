          ...
          <div class="col-md-4">
            <div class="card card-user">
              ...
              <div class="card-body">
                <div class="author">
                  <a href="#">
                    <img class="avatar border-gray" src="{{ asset('assets/admin/img/avatars/1.png') }}" alt="...">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        <label>Nama</label>
                        <input type="text" class="form-control" placeholder="Nama" value="John Doe">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="">
                        ...
                        <input type="file" class="form-control border-0" name="thumbnail" placeholder="Upload gambar" style="height: 55px; color: black" accept=".png, .jpg, .jpeg">
                      </div>
                    </div>
                  </div>
                  <div class="row">
